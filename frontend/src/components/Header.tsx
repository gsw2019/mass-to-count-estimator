...
function Header() {
  ...
  return (
    ...
    <header className="flex items-center justify-between py-3 border-b-4 border-gray-300 ">
      ...
      <div className="flex flex-col items-center gap-4 pr-15">
          <button className="button w-25 h-12">Login</button>
          <button className="button w-25 h-12">Sign Up</button>
      </div>
