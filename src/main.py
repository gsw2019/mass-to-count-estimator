...
class App:
    ...
    def __init__(self):
        ...
        # fake menu bar
        #
        self.toolbar = tk.Frame(self.root, background="gray35")
        ...
        #
        self.inventory_memory_button = tk.Menubutton(self.toolbar,
                                                     text="Inventory Memory",
                                                     background="gray35",
                                                     borderwidth=1,
                                                     foreground="snow",
                                                     activeforeground="gray20",
        ...
        self.inventory_memory_menu.add_command(label="View inventory memory", command=self.print_nothing)
        self.inventory_memory_button.config(menu=self.inventory_memory_menu)

        # history menu
        #
        self.history_button = tk.Menubutton(self.toolbar,
                                            text="History",
                                            background="gray35",
                                            relief="flat",
                                            borderwidth=1,
        ...
        self.history_menu.add_command(label="Previously generated results", command=self.print_nothing)
        ...
        #
        ttk.Label(self.mainframe, text="Mass-To-Count Estimator", font=("impact", 22), padding="10 10 10 10").pack()

        # canvas widget and scrollbar in mainframe
        #
        self.canvas = tk.Canvas(self.mainframe, background="gray85", relief="ridge", borderwidth=4.5)
        ...
        for x in range(100):
            ttk.Label(self.canvas_frame, text=f"the number {x}", font=("Arial", 18)).pack_configure(padx=20, pady=20)
